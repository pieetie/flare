...
# dimer dG37 compatibility fit, one value per nearest neighbor step
DG37_BEACON_FIT_RAW = {
    'AA': -1.1370, 'AT': -0.9730, 'TA': -0.7130, 'CA': -1.5870, 'GT': -1.5730,
    'CT': -1.3955, 'GA': -1.4430, 'CG': -2.3500, 'GC': -2.3830, 'GG': -1.9250,
}
DG37_BEACON_FIT_INIT = 1.87
DG37_BEACON_FIT_AT_PENALTY = 0.1455
DG37_BEACON_FIT_THRESHOLD = 0.35
DG37_BEACON_FIT_HAIRPIN_NUCLEATION = 1.88
DG37_BEACON_FIT_HAIRPIN_AT_PENALTY = 0.14
DG37_BEACON_FIT_HAIRPIN_THRESHOLD = 0.0
...
DG37_BEACON_FIT = _expand_dg37(DG37_BEACON_FIT_RAW)
